...
class Runner(object):
    ...
    def __init__(self, max_cpu_time, max_real_time, max_memory, box_id, max_output_size, max_process_number,
                 input_file, output_file, error_file, meta_file, run_args,
                 input_file_dir=TEST_CASE_DIR, group_memory=False,):
    ...
    def get_result(self):
        ...
        if self.cmd_status == 0 or 256:
            ...
            if output_file_size and output_file_size >= self.max_output_size:
            ...
            if 'OK' in self.cmd_result:
                ...
                if meta['status'] == 'TO':
                    ...
                    if meta['exitsig'] == 11:
                        result['info']['extra'] = 'may be three times memory limit exceeded'
                    elif meta['exitsig'] == 8:
                        result['info']['extra'] = 'may be the float point error'
                    else:
